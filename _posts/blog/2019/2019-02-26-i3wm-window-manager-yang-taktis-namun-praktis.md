...
![gambar_1]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/jj641YCy/gambar-01.png"}
...
![gambar_2]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/VNGMbfhs/gambar-02.png"}
...
![gambar_3]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/mDP93xxY/gambar-03.png"}
...
![gambar_4]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/8kF3csY5/gambar-04.png"}
...
![gambar_5]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/dtttfbtr/gambar-05.png"}
...
![gambar_6]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/mZ3wb5fm/gambar-06.png"}
...
![gambar_7]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/j5nmsrtC/gambar-08.png"}
...
![gambar_8]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/xCbfB7Z3/gambar-09.png"}
<p class="img-caption">Gambar 8 - Window Container Border Normal 0</p>

**Border Normal 1**, menggunakan <kbd>SUPER</kbd>+<kbd>T</kbd>
![gambar_9]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/QN1Nb21X/gambar-10.png"}
...
![gambar_10]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/vTrQZnb1/gambar-11.png"}
<p class="img-caption">Gambar 10 - Window Container Border Pixel 1</p>

**Border None**, menggunakan <kbd>SUPER</kbd>+<kbd>Y</kbd>
![gambar_11]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/905m2b55/gambar-12.png"}
...
![gambar_12]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/8k3jCdGY/gambar-07.png"}
...
![gambar_13]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/vBPLT0Lj/gambar-13.png"}
...
![gambar_14]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/4ymv9pW3/gambar-14.png"}
...
![gambar_16]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/1XXh2RKd/gambar-16.png"}
...
Bagi yang memerlukan contoh file konfig secara lengkap, dapat melihat pada dotfiles milik saya, [di sini](https://github.com/bandithijo/dotfiles/blob/master/.config/i3/config-dark){:target="_blank"}.
