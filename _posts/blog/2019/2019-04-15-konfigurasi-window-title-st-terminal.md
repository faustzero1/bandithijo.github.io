...
![gambar_1]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/RVVnXhvC/gambar-01.png" onerror="imgError(this);"}
...
![gambar_2]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/Kvq3VbYP/gambar-02.png" onerror="imgError(this);"}
<p class="img-caption">Gambar 2 - Tampilan detail Window Title yang menampilkan direktori aktif (<i>Default</i>)</p>

![gambar_3]({{ site.lazyload.logo_blank }}){:data-echo="https://i.postimg.cc/jSDnY1WG/gambar-03.png" onerror="imgError(this);"}
