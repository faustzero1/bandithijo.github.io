...
module Jekyll
  ...
  class Youtube < Liquid::Tag
    ...
    def render(context)
      ...
      source += "<iframe width=\"560\" height=\"315\" src=\"/assets/img/logo/logo_blank_banner.svg\" data-echo=\"//www.youtube.com/embed/#{@url}\" onerror=\"imgError(this);\" frameborder=\"0\" allowfullscreen></iframe>"
      source += "</div>"
      source
    end
